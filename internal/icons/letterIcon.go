...
func IconPath(letter string, size string, colr *color.RGBA, format string) string {
	...
	// colr (maybe)
	if colr != nil {
		parts = append(parts, ColorToHex(*colr))
	}
...
<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="50%" y="50%" dy="0.10em" font-family="Helvetica Neue, Helvetica, sans-serif" font-size="50" dominant-baseline="middle" text-anchor="middle" fill="$FG_COLOR">$LETTER</text>
</svg>
`
